  ...
  return (
    <div className="h-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10  justify-around">
        <div className="bg-green-600 shadow-lg  shadow-green-800 pt-3 rounded-md text-center text-2xl text-white  flex flex-col justify-between w-full ">
          ...
          <div className="text-white rounded-t-none rounded-md bg-green-800 p-3 text-3xl font-extrabold">
            {apartments?.data?.length}
          </div>
        </div>
        <div className="bg-purple-600 shadow-lg  shadow-purple-800 pt-3 rounded-md text-center text-2xl text-white  flex flex-col justify-between w-full ">
          <h1 className="m-auto pb-5  font-medium">
            <FaRegMoneyBillAlt className="text-6xl text-center mx-auto mb-2 bg-purple-400 rounded-full p-2" />
            Avarage Rent
          </h1>
          <div className="text-white rounded-t-none rounded-md bg-purple-800 p-3 text-3xl font-extrabold">
            {averageApartment}
          </div>
        </div>
        <div className="bg-orange-600 shadow-lg  shadow-orange-800 pt-3 rounded-md text-center text-2xl text-white  flex flex-col justify-between w-full ">
          <h1 className="m-auto pb-5  font-medium">
            <MdOutlineApartment className="text-6xl text-center mx-auto mb-2 bg-orange-400 rounded-full p-2" />
            Total Apartment
          </h1>
          <div className="text-white rounded-t-none rounded-md bg-orange-800 p-3 text-3xl font-extrabold">
            {apartments?.data?.length}
          </div>
        </div>
      </div>
